...
Матрица ошибок классицикации

```{python}
from IPython.display import Image
Image(filename='../models_metrics/model_1_heatmap.png') 
```

Основные метрики класификации
...
Из значений метрик можно сделать вывод, что мы плохо классифицируем класс "Лонгрид", причем связано это не только с тем, что представителей этого класса в обучающей выборке было относительно мало, так как категорию "Тест" мы класификацируем лучше, хотя предтавителей этого класса еще меньше. Из confusion_matrix видно, что маленькое значение метрик связано с тем, что маша модель путает "Лонгрид" и "Видео"
